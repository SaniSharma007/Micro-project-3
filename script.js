...
console.log("Vegetable Food Items:");
foodItems.forEach(item => {
...
console.log("Food Items with Highest Protein to Lowest:");
foodItems.sort((a, b) => b.protiens - a.protiens);
foodItems.forEach(item => {
  console.log(item.foodname + ": " + item.protiens);
});
console.log('-------------------------');

// Task 11: List all the food items with lowest carb content to highest
console.log("Food Items with Lowest Carb to Highest:");
foodItems.sort((a, b) => a.cab - b.cab);
foodItems.forEach(item => {
  console.log(item.foodname + ": " + item.cab);
});
console.log('-------------------------');